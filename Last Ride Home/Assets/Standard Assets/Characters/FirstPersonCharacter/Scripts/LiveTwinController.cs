...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class LiveTwinController : MonoBehaviour
    {
        ...
        public GameObject armAndPhone;
        public float armMovingSpeed=1;
        public float armClosingSpeed = 0.3f;
        public AnimationCurve armClosingCurve;

        private Rigidbody m_RigidBody;
        private CapsuleCollider m_Capsule;
        private float m_YRotation;
        private Vector3 m_GroundContactNormal;
        private float phoneApproachingTimeMax;
        private float phoneApproachingTime;
        ...
        private void Start()
        {
            ...
            phoneApproachingTimeMax = armClosingCurve.keys[armClosingCurve.length-1].time;
        }
        ...
        private void UsingPhone()
        {
            
            if (Input.GetMouseButton(1))
            {
                phoneApproachingTime += Time.deltaTime*armClosingSpeed;
            }
            else
            {
                phoneApproachingTime -= Time.deltaTime*armClosingSpeed;
            ...
            phoneApproachingTime = Mathf.Clamp(phoneApproachingTime,0f, phoneApproachingTimeMax);
            ...
            armAndPhone.transform.localPosition = new Vector3(armAndPhone.transform.localPosition.x,armAndPhone.transform.localPosition.y,
                -armClosingCurve.Evaluate(phoneApproachingTime)
                );
        }
